...
// 3: First tiny gap
{name:'Level 3', theme:'sky', spawnX:1.5, spawnY:3, finishX:55, segments:[
  {type:'flat', x:0, y:2, w:12},
  {type:'ramp', x:12, y:2, w:6, rise:1.5},
  {type:'gap',  x:18, w:3},
  {type:'flat', x:21, y:2, w:12},
  {type:'ramp', x:33, y:2, w:6, rise:1.5},
  {type:'gap',  x:39, w:3},
  {type:'flat', x:42, y:2, w:16},
]},
...
// 6: Hill climb valley
{name:'Level 6', theme:'sky', spawnX:1.5, spawnY:3, finishX:74, segments:[
  {type:'flat', x:0, y:2, w:10},
  {type:'ramp', x:10, y:2, w:8, rise:3},
  {type:'flat', x:18, y:5, w:6},
  {type:'ramp', x:24, y:5, w:8, rise:-3},
  {type:'flat', x:32, y:2, w:6},
  {type:'ramp', x:38, y:2, w:8, rise:2.5},
  {type:'gap',  x:46, w:3},
  {type:'flat', x:49, y:2, w:8},
  {type:'ramp', x:57, y:2, w:6, rise:1.5},
  {type:'flat', x:63, y:3.5, w:14},
]},
...
{name:'Level 11', theme:'sunset', spawnX:1.5, spawnY:3, finishX:86, segments:[
  ...
  {type:'ramp', x:28, y:6, w:10, rise:-4},
  {type:'flat', x:38, y:2, w:8},
...
// 15: Roller coaster
{name:'Level 15', theme:'sunset', spawnX:1.5, spawnY:3, finishX:86, segments:[
  {type:'flat', x:0, y:2, w:8},
  {type:'ramp', x:8, y:2, w:6, rise:2.5},
  {type:'ramp', x:14, y:4.5, w:6, rise:-2.5},
  {type:'ramp', x:20, y:2, w:6, rise:3.5},
  {type:'ramp', x:26, y:5.5, w:6, rise:-3.5},
  {type:'flat', x:32, y:2, w:4},
  {type:'ramp', x:36, y:2, w:6, rise:2},
  {type:'ramp', x:42, y:4, w:6, rise:-2},
  {type:'ramp', x:48, y:2, w:6, rise:4},
  {type:'flat', x:54, y:6, w:6},
  {type:'ramp', x:60, y:6, w:8, rise:-4},
  {type:'flat', x:68, y:2, w:20},
]},
...
// 17: Tall mountain + bridge
{name:'Level 17', theme:'sunset', spawnX:1.5, spawnY:3, finishX:92, segments:[
  {type:'flat',   x:0, y:2, w:10},
  {type:'ramp',   x:10, y:2, w:10, rise:5},
  {type:'flat',   x:20, y:7, w:6},
  {type:'ramp',   x:26, y:7, w:10, rise:-5},
  {type:'flat',   x:36, y:2, w:6},
  {type:'bridge', x:42, y:2, w:20, sag:2},
  {type:'flat',   x:62, y:2, w:6},
  {type:'ramp',   x:68, y:2, w:6, rise:2},
  {type:'flat',   x:74, y:4, w:20},
]},
...
// 20: Grand finale
{name:'Level 20', theme:'sunset', spawnX:1.5, spawnY:3, finishX:98, segments:[
  {type:'flat',   x:0, y:2, w:8},
  {type:'ramp',   x:8, y:2, w:6, rise:3},
  {type:'bridge', x:14, y:5, w:16, sag:1.8},
  {type:'ramp',   x:30, y:5, w:6, rise:-3},
  {type:'flat',   x:36, y:2, w:6},
  {type:'bump',   x:40, y:2, w:3, h:1.0},
  {type:'flat',   x:43, y:2, w:4},
  {type:'ramp',   x:47, y:2, w:8, rise:4},
  {type:'flat',   x:55, y:6, w:6},
  {type:'ramp',   x:61, y:6, w:8, rise:-4},
  {type:'flat',   x:69, y:2, w:4},
  {type:'bridge', x:73, y:2, w:12, sag:1.5},
  {type:'flat',   x:85, y:2, w:16},
]},
...
// 23: Staircase mountain
{name:'Level 23', theme:'forest', spawnX:1.5, spawnY:3, finishX:100, segments:[
  {type:'flat', x:0, y:2, w:8},
  {type:'ramp', x:8, y:2, w:6, rise:2},
  {type:'flat', x:14, y:4, w:4},
  {type:'ramp', x:18, y:4, w:6, rise:2},
  {type:'flat', x:24, y:6, w:4},
  {type:'ramp', x:28, y:6, w:6, rise:2},
  {type:'flat', x:34, y:8, w:8},
  {type:'ramp', x:42, y:8, w:6, rise:-2},
  {type:'flat', x:48, y:6, w:4},
  {type:'ramp', x:52, y:6, w:6, rise:-2},
  {type:'flat', x:58, y:4, w:4},
  {type:'ramp', x:62, y:4, w:6, rise:-2},
  {type:'flat', x:68, y:2, w:34},
]},
...
// 25: Spinner dodge
{name:'Level 25', theme:'forest', spawnX:1.5, spawnY:3, finishX:92,
 obstacles:[{type:'spinner', x:32, y:5.5, r:1.2, speed:2.5}],
 segments:[
  {type:'flat', x:0, y:2, w:12},
  {type:'ramp', x:12, y:2, w:6, rise:2},
  {type:'flat', x:18, y:4, w:6},
  {type:'ramp', x:24, y:4, w:6, rise:-2},
  {type:'flat', x:30, y:2, w:16},
  {type:'ramp', x:46, y:2, w:6, rise:2.5},
  {type:'flat', x:52, y:4.5, w:8},
  {type:'ramp', x:60, y:4.5, w:6, rise:-2.5},
  {type:'flat', x:66, y:2, w:28},
]},
...
// 29: Small gaps with ramps
{name:'Level 29', theme:'desert', spawnX:1.5, spawnY:3, finishX:86, segments:[
  {type:'flat', x:0, y:2, w:10},
  {type:'ramp', x:10, y:2, w:5, rise:1.5},
  {type:'gap',  x:15, w:3},
  {type:'flat', x:18, y:2, w:8},
  {type:'ramp', x:26, y:2, w:5, rise:1.5},
  {type:'gap',  x:31, w:3},
  {type:'flat', x:34, y:2, w:8},
  {type:'ramp', x:42, y:2, w:5, rise:2},
  {type:'gap',  x:47, w:3.5},
  {type:'flat', x:50.5, y:2, w:8},
  {type:'ramp', x:58.5, y:2, w:5, rise:2},
  {type:'gap',  x:63.5, w:3.5},
  {type:'flat', x:67, y:2, w:22},
]},
...
// 33: Big jump launches
{name:'Level 33', theme:'night', spawnX:1.5, spawnY:3, finishX:90, segments:[
  {type:'flat', x:0, y:2, w:12},
  {type:'ramp', x:12, y:2, w:8, rise:3},
  {type:'gap',  x:20, w:4},
  {type:'flat', x:24, y:2, w:12},
  {type:'ramp', x:36, y:2, w:8, rise:4},
  {type:'gap',  x:44, w:4},
  {type:'flat', x:48, y:2, w:44},
]},
...
// 36: Storm rolling hills
{name:'Level 36', theme:'storm', spawnX:1.5, spawnY:3, finishX:98, segments:[
  {type:'flat', x:0, y:2, w:8},
  {type:'ramp', x:8, y:2, w:6, rise:2},
  {type:'ramp', x:14, y:4, w:6, rise:-2},
  {type:'flat', x:20, y:2, w:4},
  {type:'ramp', x:24, y:2, w:6, rise:3},
  {type:'ramp', x:30, y:5, w:6, rise:-3},
  {type:'flat', x:36, y:2, w:4},
  {type:'ramp', x:40, y:2, w:6, rise:4},
  {type:'flat', x:46, y:6, w:6},
  {type:'ramp', x:52, y:6, w:6, rise:-4},
  {type:'flat', x:58, y:2, w:4},
  {type:'ramp', x:62, y:2, w:6, rise:2},
  {type:'flat', x:68, y:4, w:4},
  {type:'ramp', x:72, y:4, w:6, rise:-2},
  {type:'flat', x:78, y:2, w:22},
]},
...
{name:'Level 39', theme:'storm', spawnX:1.5, spawnY:3, finishX:104, segments:[
  {type:'flat', x:0, y:2, w:8},
  {type:'ramp', x:8, y:2, w:10, rise:5},
  {type:'flat', x:18, y:7, w:6},
  {type:'ramp', x:24, y:7, w:6, rise:2},
  {type:'gap',  x:30, w:3},
  {type:'flat', x:33, y:7, w:6},
  {type:'ramp', x:39, y:7, w:10, rise:-5},
  {type:'flat', x:49, y:2, w:6},
  {type:'ramp', x:55, y:2, w:10, rise:6},
  {type:'flat', x:65, y:8, w:6},
  {type:'ramp', x:71, y:8, w:10, rise:-6},
  {type:'flat', x:81, y:2, w:26},
]},
...
// 41: Candy hills
{name:'Level 41', theme:'candy', spawnX:1.5, spawnY:3, finishX:100, segments:[
  {type:'flat', x:0, y:2, w:8},
  {type:'ramp', x:8, y:2, w:6, rise:3},
  {type:'flat', x:14, y:5, w:4},
  {type:'ramp', x:18, y:5, w:6, rise:-3},
  {type:'flat', x:24, y:2, w:4},
  {type:'ramp', x:28, y:2, w:6, rise:4},
  {type:'flat', x:34, y:6, w:6},
  {type:'ramp', x:40, y:6, w:6, rise:-4},
  {type:'flat', x:46, y:2, w:4},
  {type:'ramp', x:50, y:2, w:6, rise:3},
  {type:'flat', x:56, y:5, w:4},
  {type:'ramp', x:60, y:5, w:6, rise:-3},
  {type:'flat', x:66, y:2, w:4},
  {type:'bump', x:68, y:2, w:3, h:1.0},
  {type:'flat', x:71, y:2, w:32},
]},
...
// 46: Space peaks
{name:'Level 46', theme:'space', spawnX:1.5, spawnY:3, finishX:108, segments:[
  {type:'flat', x:0, y:2, w:8},
  {type:'ramp', x:8, y:2, w:8, rise:5},
  {type:'flat', x:16, y:7, w:6},
  {type:'ramp', x:22, y:7, w:8, rise:-5},
  {type:'flat', x:30, y:2, w:6},
  {type:'ramp', x:36, y:2, w:8, rise:6},
  {type:'flat', x:44, y:8, w:6},
  {type:'ramp', x:50, y:8, w:8, rise:-6},
  {type:'flat', x:58, y:2, w:6},
  {type:'ramp', x:64, y:2, w:8, rise:4},
  {type:'flat', x:72, y:6, w:6},
  {type:'ramp', x:78, y:6, w:8, rise:-4},
...
// 50: FINAL — Ultimate challenge
{name:'Level 50', theme:'space', spawnX:1.5, spawnY:3, finishX:128,
 obstacles:[
   {type:'spinner', x:60, y:5.5, r:1.3, speed:4},
   {type:'spinner', x:90, y:11.5, r:1.3, speed:4.5},
 ],
 segments:[
  {type:'flat',   x:0, y:2, w:8},
  {type:'ramp',   x:8, y:2, w:8, rise:4},
  {type:'flat',   x:16, y:6, w:4},
  {type:'ramp',   x:20, y:6, w:8, rise:-4},
  {type:'flat',   x:28, y:2, w:4},
  {type:'bump',   x:30, y:2, w:3, h:1.0},
  {type:'flat',   x:33, y:2, w:4},
  {type:'bridge', x:37, y:2, w:18, sag:2.5},
  {type:'flat',   x:55, y:2, w:6},
  {type:'ramp',   x:61, y:2, w:6, rise:2},
  {type:'gap',    x:67, w:3},
  {type:'flat',   x:70, y:2, w:6},
  {type:'ramp',   x:76, y:2, w:10, rise:6},
  {type:'flat',   x:86, y:8, w:8},
  {type:'ramp',   x:94, y:8, w:10, rise:-6},
  {type:'flat',   x:104, y:2, w:26},
]},
