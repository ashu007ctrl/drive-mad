...
const LEVELS = [
  ...
  // 26: Emerald Ridgeline Colossus (5-Tier Alpine Steps, Canopy Lift & Triple Roller Curves)
  {
    name: 'Level 26: Emerald Ridgeline Colossus', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 600,
    segments: [
      // Sector 1: Severe Washboard into 5-Tier Alpine Steps (x: 0 - 87)
      { type: 'flat', x: 0, y: 2, w: 7 },
      { type: 'bump', x: 7, y: 2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 10.5, y: 2, w: 2.5 },
      { type: 'bump', x: 13, y: 2, w: 3.5, h: 0.72 },
      ...
      { type: 'flat', x: 34.5, y: 5.6, w: 3.5 },
      { type: 'ramp', x: 38.0, y: 5.6, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 40.5, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 44.0, y: 6.8, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 46.5, y: 8.0, w: 4.5 },
      { type: 'ramp', x: 51.0, y: 8.0, w: 9.0, rise: -5.8 },
      { type: 'flat', x: 60.0, y: 2.2, w: 4.0 },
      { type: 'bump', x: 64.0, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 67.5, y: 2.2, w: 3.0 },
      { type: 'ramp', x: 70.5, y: 2.2, w: 6.5, rise: 3.2 },
      { type: 'flat', x: 77.0, y: 5.4, w: 3.5 },
      { type: 'ramp', x: 80.5, y: 5.4, w: 6.5, rise: -3.2 },
      { type: 'flat', x: 87.0, y: 2.2, w: 18.0 },

      // Sector 2: Sawmill Chamber 1 Staggered Dual Spinners (x: 105 - 185)
      { type: 'bump', x: 105.0, y: 2.2, w: 3.5, h: 0.58 },
      { type: 'flat', x: 108.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 111.5, y: 2.2, w: 20.0 },
      { type: 'bump', x: 131.5, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 135.0, y: 2.2, w: 3.0 },
      { type: 'flat', x: 138.0, y: 2.2, w: 20.0 },
      { type: 'ramp', x: 158.0, y: 2.2, w: 7.0, rise: 4.2 },
      { type: 'flat', x: 165.0, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 168.5, y: 6.4, w: 7.0, rise: -4.2 },
      { type: 'flat', x: 175.5, y: 2.2, w: 9.5 },

      // Sector 3: Hydraulic Canopy Lift & High Suspension Bridge (x: 185 - 270)
      { type: 'gap', x: 185.0, w: 13.0 },
      { type: 'moving', x: 185.8, y: 4.75, w: 11.5, range: 0, rangeY: 2.55, speed: 1.15, phase: -1.57 },
      { type: 'flat', x: 198.0, y: 7.3, w: 6.0 },
      { type: 'bridge', x: 204.0, y: 7.3, w: 24.0, sag: 2.2 },
      { type: 'flat', x: 228.0, y: 7.3, w: 4.0 },
      { type: 'ramp', x: 232.0, y: 7.3, w: 8.5, rise: -5.1 },
      { type: 'flat', x: 240.5, y: 2.2, w: 5.0 },
      { type: 'bump', x: 245.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 249.0, y: 2.2, w: 21.0 },

      // Sector 4: Extreme Steep Ridge & Tandem See-Saws (x: 270 - 360)
      { type: 'ramp', x: 270.0, y: 2.2, w: 7.0, rise: 4.8 },
      { type: 'flat', x: 277.0, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 280.5, y: 7.0, w: 7.0, rise: -4.8 },
      { type: 'flat', x: 287.5, y: 2.2, w: 4.0 },
      { type: 'gap', x: 291.5, w: 0.8 },
      { type: 'see-saw', x: 292.3, y: 2.2, w: 10.0 },
      { type: 'gap', x: 302.3, w: 0.8 },
      { type: 'flat', x: 303.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 306.6, w: 0.8 },
      { type: 'see-saw', x: 307.4, y: 2.2, w: 10.0 },
      { type: 'gap', x: 317.4, w: 0.8 },
      { type: 'flat', x: 318.2, y: 2.2, w: 4.0 },
      { type: 'ramp', x: 322.2, y: 2.2, w: 6.5, rise: 3.6 },
      { type: 'flat', x: 328.7, y: 5.8, w: 3.5 },
      { type: 'ramp', x: 332.2, y: 5.8, w: 7.0, rise: -3.6 },
      { type: 'flat', x: 339.2, y: 2.2, w: 20.8 },

      // Sector 5: Sawmill Chamber 2 Fast Blades (x: 360 - 435)
      { type: 'flat', x: 360.0, y: 2.2, w: 16.0 },
      { type: 'bump', x: 376.0, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 379.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 382.5, y: 2.2, w: 18.0 },
      { type: 'ramp', x: 400.5, y: 2.2, w: 6.5, rise: 3.4 },
      { type: 'flat', x: 407.0, y: 5.6, w: 4.0 },
      { type: 'ramp', x: 411.0, y: 5.6, w: 6.5, rise: -3.4 },
      { type: 'flat', x: 417.5, y: 2.2, w: 17.5 },

      // Sector 6: Skyway Ferry & Precision Spring Bounce (x: 435 - 515)
      { type: 'gap', x: 435.0, w: 15.0 },
      { type: 'moving', x: 437.2, y: 2.2, w: 8.5, range: 2.6, speed: 1.55, phase: 0 },
      { type: 'flat', x: 450.0, y: 2.2, w: 6.0 },
      { type: 'bump', x: 456.0, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 459.5, y: 2.2, w: 3.0 },
      { type: 'bounce', x: 462.5, y: 2.2, w: 3.0, power: 15.5 },
      { type: 'gap', x: 465.5, w: 1.2 },
      { type: 'flat', x: 466.7, y: 3.8, w: 10.0 },
      { type: 'ramp', x: 476.7, y: 3.8, w: 7.3, rise: -1.6 },
      { type: 'flat', x: 484.0, y: 2.2, w: 6.0 },
      { type: 'bridge', x: 490.0, y: 2.2, w: 18.0, sag: 1.5 },
      { type: 'flat', x: 508.0, y: 2.2, w: 7.0 },

      // Sector 7: Triple Roller-Coaster Switchbacks & Victory Dash (x: 515 - 625)
      { type: 'ramp', x: 515.0, y: 2.2, w: 6.5, rise: 4.6 },
      { type: 'flat', x: 521.5, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 525.0, y: 6.8, w: 6.5, rise: -4.6 },
      { type: 'ramp', x: 531.5, y: 2.2, w: 6.5, rise: 4.2 },
      { type: 'flat', x: 538.0, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 541.5, y: 6.4, w: 6.5, rise: -4.2 },
      { type: 'ramp', x: 548.0, y: 2.2, w: 6.0, rise: 3.6 },
      { type: 'flat', x: 554.0, y: 5.8, w: 3.5 },
      { type: 'ramp', x: 557.5, y: 5.8, w: 6.0, rise: -3.6 },
      { type: 'flat', x: 563.5, y: 2.2, w: 4.0 },
      { type: 'boost', x: 567.5, y: 2.2, w: 8.0, rise: 0, power: 34 },
      { type: 'flat', x: 575.5, y: 2.2, w: 49.5 },
    ],
    obstacles: [
      { type: 'spinner', x: 121.5, y: 6.1, r: 1.5, speed: 2.2 },
      { type: 'spinner', x: 148.0, y: 6.1, r: 1.5, speed: -2.2 },
      { type: 'spinner', x: 370.0, y: 6.1, r: 1.5, speed: 2.5 },
      { type: 'spinner', x: 392.0, y: 6.1, r: 1.5, speed: -2.5 },
    ]
  },

  // 27: Timberline Ravine & Quad Gauntlet (Deep Gullies, Quad Spinners & Tandem See-Saws)
  {
    name: 'Level 27: Timberline Ravine & Quad Gauntlet', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 620,
    segments: [
      // Sector 1: Washboard Waves & Double Camelback Bumps (x: 0 - 85)
      { type: 'flat', x: 0, y: 2, w: 7 },
      { type: 'bump', x: 7, y: 2, w: 3.5, h: 0.68 },
      { type: 'flat', x: 10.5, y: 2, w: 2.5 },
      { type: 'bump', x: 13, y: 2, w: 3.5, h: 0.74 },
      { type: 'flat', x: 16.5, y: 2, w: 3.0 },
      { type: 'bump', x: 19.5, y: 2, w: 3.5, h: 0.70 },
      { type: 'flat', x: 23.0, y: 2, w: 4.0 },
      { type: 'ramp', x: 27.0, y: 2.0, w: 6.5, rise: 3.5 },
      { type: 'flat', x: 33.5, y: 5.5, w: 3.5 },
      { type: 'ramp', x: 37.0, y: 5.5, w: 6.5, rise: -3.5 },
      { type: 'flat', x: 43.5, y: 2.0, w: 3.5 },
      { type: 'ramp', x: 47.0, y: 2.0, w: 7.0, rise: 4.2 },
      { type: 'flat', x: 54.0, y: 6.2, w: 3.5 },
      { type: 'ramp', x: 57.5, y: 6.2, w: 7.5, rise: -4.0 },
      { type: 'flat', x: 65.0, y: 2.2, w: 20.0 },

      // Sector 2: Deep Timberline Ravine Plunge & Valley Ascent (x: 85 - 170)
      { type: 'ramp', x: 85.0, y: 2.2, w: 8.0, rise: 4.8 },
      { type: 'flat', x: 93.0, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 96.5, y: 7.0, w: 8.5, rise: -4.8 },
      { type: 'flat', x: 105.0, y: 2.2, w: 4.0 },
      { type: 'bridge', x: 109.0, y: 2.2, w: 24.0, sag: 2.2 },
      { type: 'flat', x: 133.0, y: 2.2, w: 4.0 },
      { type: 'ramp', x: 137.0, y: 2.2, w: 7.0, rise: 4.5 },
      { type: 'flat', x: 144.0, y: 6.7, w: 3.5 },
      { type: 'ramp', x: 147.5, y: 6.7, w: 7.5, rise: -4.5 },
      { type: 'flat', x: 155.0, y: 2.2, w: 15.0 },

      // Sector 3: Sawmill Quad Spinners Gauntlet (x: 170 - 260)
      { type: 'bump', x: 170.0, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 173.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 176.5, y: 2.2, w: 18.0 },
      { type: 'bump', x: 194.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 198.0, y: 2.2, w: 3.0 },
      { type: 'flat', x: 201.0, y: 2.2, w: 18.0 },
      { type: 'bump', x: 219.0, y: 2.2, w: 3.5, h: 0.64 },
      { type: 'flat', x: 222.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 225.5, y: 2.2, w: 18.0 },
      { type: 'ramp', x: 243.5, y: 2.2, w: 7.0, rise: 3.8 },
      { type: 'flat', x: 250.5, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 254.0, y: 6.0, w: 7.0, rise: -3.8 },
      { type: 'flat', x: 261.0, y: 2.2, w: 9.0 },

      // Sector 4: Hydraulic Canopy Tower & Skyway Bridge (x: 270 - 355)
      { type: 'gap', x: 270.0, w: 13.0 },
      { type: 'moving', x: 270.8, y: 4.8, w: 11.5, range: 0, rangeY: 2.6, speed: 1.2, phase: -1.57 },
      { type: 'flat', x: 283.0, y: 7.4, w: 6.0 },
      { type: 'bridge', x: 289.0, y: 7.4, w: 24.0, sag: 2.2 },
      { type: 'flat', x: 313.0, y: 7.4, w: 4.0 },
      { type: 'ramp', x: 317.0, y: 7.4, w: 9.0, rise: -5.2 },
      { type: 'flat', x: 326.0, y: 2.2, w: 5.0 },
      { type: 'bump', x: 331.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 334.5, y: 2.2, w: 20.5 },

      // Sector 5: Steep Ridge & Tandem See-Saws (x: 355 - 445)
      { type: 'ramp', x: 355.0, y: 2.2, w: 7.0, rise: 5.0 },
      { type: 'flat', x: 362.0, y: 7.2, w: 3.5 },
      { type: 'ramp', x: 365.5, y: 7.2, w: 7.0, rise: -5.0 },
      { type: 'flat', x: 372.5, y: 2.2, w: 4.0 },
      { type: 'gap', x: 376.5, w: 0.8 },
      { type: 'see-saw', x: 377.3, y: 2.2, w: 10.0 },
      { type: 'gap', x: 387.3, w: 0.8 },
      { type: 'flat', x: 388.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 391.6, w: 0.8 },
      { type: 'see-saw', x: 392.4, y: 2.2, w: 10.0 },
      { type: 'gap', x: 402.4, w: 0.8 },
      { type: 'flat', x: 403.2, y: 2.2, w: 4.0 },
      { type: 'ramp', x: 407.2, y: 2.2, w: 6.5, rise: 3.6 },
      { type: 'flat', x: 413.7, y: 5.8, w: 3.5 },
      { type: 'ramp', x: 417.2, y: 5.8, w: 7.0, rise: -3.6 },
      { type: 'flat', x: 424.2, y: 2.2, w: 20.8 },

      // Sector 6: Dual Skyway Ferries across Chasm (x: 445 - 530)
      { type: 'gap', x: 445.0, w: 15.0 },
      { type: 'moving', x: 447.2, y: 2.2, w: 8.5, range: 2.6, speed: 1.5, phase: 0 },
      { type: 'flat', x: 460.0, y: 2.2, w: 6.0 },
      { type: 'bump', x: 466.0, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 469.5, y: 2.2, w: 4.0 },
      { type: 'gap', x: 473.5, w: 15.0 },
      { type: 'moving', x: 475.7, y: 2.2, w: 8.5, range: 2.6, speed: 1.6, phase: 3.14 },
      { type: 'flat', x: 488.5, y: 2.2, w: 6.0 },
      { type: 'bridge', x: 494.5, y: 2.2, w: 18.0, sag: 1.4 },
      { type: 'flat', x: 512.5, y: 2.2, w: 17.5 },

      // Sector 7: Quad Roller Coaster Switchbacks & Grand Sprint (x: 530 - 645)
      { type: 'ramp', x: 530.0, y: 2.2, w: 6.5, rise: 4.8 },
      { type: 'flat', x: 536.5, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 540.0, y: 7.0, w: 6.5, rise: -4.8 },
      { type: 'ramp', x: 546.5, y: 2.2, w: 6.5, rise: 4.4 },
      { type: 'flat', x: 553.0, y: 6.6, w: 3.5 },
      { type: 'ramp', x: 556.5, y: 6.6, w: 6.5, rise: -4.4 },
      { type: 'ramp', x: 563.0, y: 2.2, w: 6.0, rise: 3.8 },
      { type: 'flat', x: 569.0, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 572.5, y: 6.0, w: 6.0, rise: -3.8 },
      { type: 'flat', x: 578.5, y: 2.2, w: 4.0 },
      { type: 'boost', x: 582.5, y: 2.2, w: 8.0, rise: 0, power: 34 },
      { type: 'flat', x: 590.5, y: 2.2, w: 54.5 },
    ],
    obstacles: [
      { type: 'spinner', x: 185.0, y: 6.1, r: 1.5, speed: 2.2 },
      { type: 'spinner', x: 210.0, y: 6.1, r: 1.5, speed: -2.4 },
      { type: 'spinner', x: 235.0, y: 6.1, r: 1.5, speed: 2.6 },
      { type: 'spinner', x: 503.5, y: 5.6, r: 1.3, speed: -2.2 },
    ]
  },

  // 28: Alpine Apex & Canopy Lifts (5-Tier Staircase, Triple See-Saws & Aerial Lifts)
  {
    name: 'Level 28: Alpine Apex & Canopy Lifts', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 640,
    segments: [
      ...
      { type: 'flat', x: 22.0, y: 3.2, w: 3.5 },
      { type: 'ramp', x: 25.5, y: 3.2, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 28.0, y: 4.4, w: 3.5 },
      { type: 'ramp', x: 31.5, y: 4.4, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 34.0, y: 5.6, w: 3.5 },
      { type: 'ramp', x: 37.5, y: 5.6, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 40.0, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 43.5, y: 6.8, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 46.0, y: 8.0, w: 4.5 },
      { type: 'ramp', x: 50.5, y: 8.0, w: 9.5, rise: -5.8 },
      { type: 'flat', x: 60.0, y: 2.2, w: 4.0 },
      { type: 'bump', x: 64.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 67.5, y: 2.2, w: 3.0 },
      { type: 'ramp', x: 70.5, y: 2.2, w: 6.5, rise: 3.5 },
      { type: 'flat', x: 77.0, y: 5.7, w: 3.5 },
      { type: 'ramp', x: 80.5, y: 5.7, w: 6.5, rise: -3.5 },
      { type: 'flat', x: 87.0, y: 2.2, w: 18.0 },

      // Sector 2: Sawmill Chamber 1 High-Velocity Spinners (x: 105 - 190)
      { type: 'bump', x: 105.0, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 108.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 111.5, y: 2.2, w: 20.0 },
      { type: 'bump', x: 131.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 135.0, y: 2.2, w: 3.0 },
      { type: 'flat', x: 138.0, y: 2.2, w: 20.0 },
      { type: 'ramp', x: 158.0, y: 2.2, w: 7.0, rise: 4.5 },
      { type: 'flat', x: 165.0, y: 6.7, w: 3.5 },
      { type: 'ramp', x: 168.5, y: 6.7, w: 7.5, rise: -4.5 },
      { type: 'flat', x: 176.0, y: 2.2, w: 14.0 },

      // Sector 3: Hydraulic Canopy Lift & High Wire Bridge (x: 190 - 280)
      { type: 'gap', x: 190.0, w: 13.0 },
      { type: 'moving', x: 190.8, y: 4.85, w: 11.5, range: 0, rangeY: 2.65, speed: 1.2, phase: -1.57 },
      { type: 'flat', x: 203.0, y: 7.5, w: 6.0 },
      { type: 'bridge', x: 209.0, y: 7.5, w: 24.0, sag: 2.3 },
      { type: 'flat', x: 233.0, y: 7.5, w: 4.0 },
      { type: 'ramp', x: 237.0, y: 7.5, w: 9.0, rise: -5.3 },
      { type: 'flat', x: 246.0, y: 2.2, w: 5.0 },
      { type: 'bump', x: 251.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 254.5, y: 2.2, w: 25.5 },

      // Sector 4: Alpine Apex Peak & Triple See-Saws (x: 280 - 375)
      { type: 'ramp', x: 280.0, y: 2.2, w: 7.0, rise: 5.2 },
      { type: 'flat', x: 287.0, y: 7.4, w: 3.5 },
      { type: 'ramp', x: 290.5, y: 7.4, w: 7.0, rise: -5.2 },
      { type: 'flat', x: 297.5, y: 2.2, w: 4.0 },
      { type: 'gap', x: 301.5, w: 0.8 },
      { type: 'see-saw', x: 302.3, y: 2.2, w: 10.0 },
      { type: 'gap', x: 312.3, w: 0.8 },
      { type: 'flat', x: 313.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 316.6, w: 0.8 },
      { type: 'see-saw', x: 317.4, y: 2.2, w: 10.0 },
      { type: 'gap', x: 327.4, w: 0.8 },
      { type: 'flat', x: 328.2, y: 2.2, w: 3.5 },
      { type: 'gap', x: 331.7, w: 0.8 },
      { type: 'see-saw', x: 332.5, y: 2.2, w: 10.0 },
      { type: 'gap', x: 342.5, w: 0.8 },
      { type: 'flat', x: 343.3, y: 2.2, w: 4.0 },
      { type: 'ramp', x: 347.3, y: 2.2, w: 6.5, rise: 3.8 },
      { type: 'flat', x: 353.8, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 357.3, y: 6.0, w: 7.0, rise: -3.8 },
      { type: 'flat', x: 364.3, y: 2.2, w: 20.7 },

      // Sector 5: Sawmill Chamber 2 Fast Blades & Moguls (x: 385 - 460)
      { type: 'flat', x: 385.0, y: 2.2, w: 16.0 },
      { type: 'bump', x: 401.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 404.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 407.5, y: 2.2, w: 20.0 },
      { type: 'ramp', x: 427.5, y: 2.2, w: 6.5, rise: 3.6 },
      { type: 'flat', x: 434.0, y: 5.8, w: 4.0 },
      { type: 'ramp', x: 438.0, y: 5.8, w: 6.5, rise: -3.6 },
      { type: 'flat', x: 444.5, y: 2.2, w: 15.5 },

      // Sector 6: Skyway Ferry & Spring Bounce to High Ledge (x: 460 - 540)
      { type: 'gap', x: 460.0, w: 15.0 },
      { type: 'moving', x: 462.2, y: 2.2, w: 8.5, range: 2.6, speed: 1.55, phase: 0 },
      { type: 'flat', x: 475.0, y: 2.2, w: 6.0 },
      { type: 'bump', x: 481.0, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 484.5, y: 2.2, w: 3.0 },
      { type: 'bounce', x: 487.5, y: 2.2, w: 3.0, power: 15.5 },
      { type: 'gap', x: 490.5, w: 1.2 },
      { type: 'flat', x: 491.7, y: 3.8, w: 10.0 },
      { type: 'ramp', x: 501.7, y: 3.8, w: 7.3, rise: -1.6 },
      { type: 'flat', x: 509.0, y: 2.2, w: 6.0 },
      { type: 'bridge', x: 515.0, y: 2.2, w: 18.0, sag: 1.5 },
      { type: 'flat', x: 533.0, y: 2.2, w: 7.0 },

      // Sector 7: Quad Roller-Coaster Switchbacks & Grand Finale (x: 540 - 665)
      { type: 'ramp', x: 540.0, y: 2.2, w: 6.5, rise: 5.0 },
      { type: 'flat', x: 546.5, y: 7.2, w: 3.5 },
      { type: 'ramp', x: 550.0, y: 7.2, w: 6.5, rise: -5.0 },
      { type: 'ramp', x: 556.5, y: 2.2, w: 6.5, rise: 4.6 },
      { type: 'flat', x: 563.0, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 566.5, y: 6.8, w: 6.5, rise: -4.6 },
      { type: 'ramp', x: 573.0, y: 2.2, w: 6.0, rise: 4.0 },
      { type: 'flat', x: 579.0, y: 6.2, w: 3.5 },
      { type: 'ramp', x: 582.5, y: 6.2, w: 6.0, rise: -4.0 },
      { type: 'ramp', x: 588.5, y: 2.2, w: 5.5, rise: 3.2 },
      { type: 'flat', x: 594.0, y: 5.4, w: 3.5 },
      { type: 'ramp', x: 597.5, y: 5.4, w: 5.5, rise: -3.2 },
      { type: 'flat', x: 603.0, y: 2.2, w: 4.0 },
      { type: 'boost', x: 607.0, y: 2.2, w: 8.0, rise: 0, power: 34 },
      { type: 'flat', x: 615.0, y: 2.2, w: 50.0 },
    ],
    obstacles: [
      { type: 'spinner', x: 121.5, y: 6.1, r: 1.5, speed: 2.3 },
      { type: 'spinner', x: 148.0, y: 6.1, r: 1.5, speed: -2.3 },
      { type: 'spinner', x: 395.0, y: 6.1, r: 1.5, speed: 2.6 },
      { type: 'spinner', x: 417.5, y: 6.1, r: 1.5, speed: -2.6 },
      { type: 'spinner', x: 524.0, y: 5.7, r: 1.3, speed: 2.4 },
    ]
  },

  // 29: Overdrive Gorge & Matrix Spinners (6-Tier Escalator, Monster Plunge & 5 Spinners)
  {
    name: 'Level 29: Overdrive Gorge & Matrix Spinners', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 660,
    segments: [
      // Sector 1: Severe Moguls & 6-Tier Stepped Escalator to y: 9.2 (x: 0 - 95)
      { type: 'flat', x: 0, y: 2, w: 7 },
      { type: 'bump', x: 7, y: 2, w: 3.5, h: 0.70 },
      { type: 'flat', x: 10.5, y: 2, w: 2.5 },
      { type: 'bump', x: 13, y: 2, w: 3.5, h: 0.76 },
      { type: 'flat', x: 16.5, y: 2, w: 3.0 },
      { type: 'ramp', x: 19.5, y: 2.0, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 22.0, y: 3.2, w: 3.5 },
      { type: 'ramp', x: 25.5, y: 3.2, w: 2.5, rise: 1.2 },
      ...
      { type: 'flat', x: 40.0, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 43.5, y: 6.8, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 46.0, y: 8.0, w: 3.5 },
      { type: 'ramp', x: 49.5, y: 8.0, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 52.0, y: 9.2, w: 4.5 },
      { type: 'ramp', x: 56.5, y: 9.2, w: 10.0, rise: -7.0 },
      { type: 'flat', x: 66.5, y: 2.2, w: 4.0 },
      { type: 'bump', x: 70.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 74.0, y: 2.2, w: 3.0 },
      { type: 'ramp', x: 77.0, y: 2.2, w: 6.5, rise: 3.8 },
      { type: 'flat', x: 83.5, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 87.0, y: 6.0, w: 6.5, rise: -3.8 },
      { type: 'flat', x: 93.5, y: 2.2, w: 16.5 },

      // Sector 2: Sawmill Chamber 1 Matrix Blades (x: 110 - 195)
      { type: 'bump', x: 110.0, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 113.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 116.5, y: 2.2, w: 20.0 },
      { type: 'bump', x: 136.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 140.0, y: 2.2, w: 3.0 },
      { type: 'flat', x: 143.0, y: 2.2, w: 20.0 },
      { type: 'ramp', x: 163.0, y: 2.2, w: 7.0, rise: 4.6 },
      { type: 'flat', x: 170.0, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 173.5, y: 6.8, w: 7.5, rise: -4.6 },
      { type: 'flat', x: 181.0, y: 2.2, w: 14.0 },

      // Sector 3: Hydraulic Mountain Lift & High Canopy Bridge (x: 195 - 285)
      { type: 'gap', x: 195.0, w: 13.0 },
      { type: 'moving', x: 195.8, y: 4.85, w: 11.5, range: 0, rangeY: 2.65, speed: 1.25, phase: -1.57 },
      { type: 'flat', x: 208.0, y: 7.5, w: 6.0 },
      { type: 'bridge', x: 214.0, y: 7.5, w: 24.0, sag: 2.3 },
      { type: 'flat', x: 238.0, y: 7.5, w: 4.0 },
      { type: 'ramp', x: 242.0, y: 7.5, w: 9.0, rise: -5.3 },
      { type: 'flat', x: 251.0, y: 2.2, w: 5.0 },
      { type: 'bump', x: 256.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 259.5, y: 2.2, w: 25.5 },

      // Sector 4: Overdrive Steep Apex & Triple See-Saws (x: 285 - 380)
      { type: 'ramp', x: 285.0, y: 2.2, w: 7.0, rise: 5.4 },
      { type: 'flat', x: 292.0, y: 7.6, w: 3.5 },
      { type: 'ramp', x: 295.5, y: 7.6, w: 7.0, rise: -5.4 },
      { type: 'flat', x: 302.5, y: 2.2, w: 4.0 },
      { type: 'gap', x: 306.5, w: 0.8 },
      { type: 'see-saw', x: 307.3, y: 2.2, w: 10.0 },
      { type: 'gap', x: 317.3, w: 0.8 },
      { type: 'flat', x: 318.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 321.6, w: 0.8 },
      { type: 'see-saw', x: 322.4, y: 2.2, w: 10.0 },
      { type: 'gap', x: 332.4, w: 0.8 },
      { type: 'flat', x: 333.2, y: 2.2, w: 3.5 },
      { type: 'gap', x: 336.7, w: 0.8 },
      { type: 'see-saw', x: 337.5, y: 2.2, w: 10.0 },
      { type: 'gap', x: 347.5, w: 0.8 },
      { type: 'flat', x: 348.3, y: 2.2, w: 4.0 },
      { type: 'ramp', x: 352.3, y: 2.2, w: 6.5, rise: 3.8 },
      { type: 'flat', x: 358.8, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 362.3, y: 6.0, w: 7.0, rise: -3.8 },
      { type: 'flat', x: 369.3, y: 2.2, w: 20.7 },

      // Sector 5: Sawmill Chamber 2 Matrix Blades & Moguls (x: 390 - 475)
      { type: 'flat', x: 390.0, y: 2.2, w: 16.0 },
      { type: 'bump', x: 406.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 409.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 412.5, y: 2.2, w: 20.0 },
      { type: 'ramp', x: 432.5, y: 2.2, w: 6.5, rise: 3.6 },
      { type: 'flat', x: 439.0, y: 5.8, w: 4.0 },
      { type: 'ramp', x: 443.0, y: 5.8, w: 6.5, rise: -3.6 },
      { type: 'flat', x: 449.5, y: 2.2, w: 25.5 },

      // Sector 6: Dual Moving Ferries across Overdrive Chasm (x: 475 - 560)
      { type: 'gap', x: 475.0, w: 15.0 },
      { type: 'moving', x: 477.2, y: 2.2, w: 8.5, range: 2.6, speed: 1.55, phase: 0 },
      { type: 'flat', x: 490.0, y: 2.2, w: 6.0 },
      { type: 'bump', x: 496.0, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 499.5, y: 2.2, w: 3.0 },
      { type: 'bounce', x: 502.5, y: 2.2, w: 3.0, power: 15.5 },
      { type: 'gap', x: 505.5, w: 1.2 },
      { type: 'flat', x: 506.7, y: 3.8, w: 10.0 },
      { type: 'ramp', x: 516.7, y: 3.8, w: 7.3, rise: -1.6 },
      { type: 'flat', x: 524.0, y: 2.2, w: 6.0 },
      { type: 'bridge', x: 530.0, y: 2.2, w: 18.0, sag: 1.5 },
      { type: 'flat', x: 548.0, y: 2.2, w: 12.0 },

      // Sector 7: Quintuple Roller-Coaster Switchbacks & Nitro Finale (x: 560 - 685)
      { type: 'ramp', x: 560.0, y: 2.2, w: 6.5, rise: 5.2 },
      { type: 'flat', x: 566.5, y: 7.4, w: 3.5 },
      { type: 'ramp', x: 570.0, y: 7.4, w: 6.5, rise: -5.2 },
      { type: 'ramp', x: 576.5, y: 2.2, w: 6.5, rise: 4.8 },
      { type: 'flat', x: 583.0, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 586.5, y: 7.0, w: 6.5, rise: -4.8 },
      { type: 'ramp', x: 593.0, y: 2.2, w: 6.0, rise: 4.4 },
      { type: 'flat', x: 599.0, y: 6.6, w: 3.5 },
      { type: 'ramp', x: 602.5, y: 6.6, w: 6.0, rise: -4.4 },
      { type: 'ramp', x: 608.5, y: 2.2, w: 5.5, rise: 3.8 },
      { type: 'flat', x: 614.0, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 617.5, y: 6.0, w: 5.5, rise: -3.8 },
      { type: 'flat', x: 623.0, y: 2.2, w: 4.0 },
      { type: 'boost', x: 627.0, y: 2.2, w: 8.0, rise: 0, power: 34 },
      { type: 'flat', x: 635.0, y: 2.2, w: 50.0 },
    ],
    obstacles: [
      { type: 'spinner', x: 126.5, y: 6.1, r: 1.5, speed: 2.4 },
      { type: 'spinner', x: 153.0, y: 6.1, r: 1.5, speed: -2.4 },
      { type: 'spinner', x: 400.0, y: 6.1, r: 1.5, speed: 2.7 },
      { type: 'spinner', x: 422.5, y: 6.1, r: 1.5, speed: -2.7 },
      { type: 'spinner', x: 539.0, y: 5.7, r: 1.3, speed: 2.5 },
    ]
  },

  // 30: The Forest Titan Colossus (World 3 Grand Climax — 710 Finish, 6 Spinners, 8 Sectors)
  {
    name: 'Level 30: The Forest Titan Colossus', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 710,
    segments: [
      // Sector 1: The Titan Gate — Severe Mogul Gauntlet & 6-Tier Stepped Escalator to y: 9.2 (x: 0 - 95)
      { type: 'flat', x: 0, y: 2, w: 7 },
      { type: 'bump', x: 7, y: 2, w: 3.5, h: 0.72 },
      { type: 'flat', x: 10.5, y: 2, w: 2.5 },
      { type: 'bump', x: 13, y: 2, w: 3.5, h: 0.78 },
      { type: 'flat', x: 16.5, y: 2, w: 3.0 },
      { type: 'ramp', x: 19.5, y: 2.0, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 22.0, y: 3.2, w: 3.5 },
      { type: 'ramp', x: 25.5, y: 3.2, w: 2.5, rise: 1.2 },
      ...
      { type: 'ramp', x: 56.5, y: 9.2, w: 10.0, rise: -7.0 },
      { type: 'flat', x: 66.5, y: 2.2, w: 4.0 },
      { type: 'bump', x: 70.5, y: 2.2, w: 3.5, h: 0.68 },
      { type: 'flat', x: 74.0, y: 2.2, w: 3.0 },
      { type: 'ramp', x: 77.0, y: 2.2, w: 6.5, rise: 3.8 },
      { type: 'flat', x: 83.5, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 87.0, y: 6.0, w: 6.5, rise: -3.8 },
      ...
      // Sector 2: The Screaming Canyon Plunge & Giant Suspension Bridge (x: 110 - 205)
      { type: 'ramp', x: 110.0, y: 2.2, w: 8.0, rise: 5.2 },
      { type: 'flat', x: 118.0, y: 7.4, w: 3.5 },
      { type: 'ramp', x: 121.5, y: 7.4, w: 8.5, rise: -5.2 },
      { type: 'flat', x: 130.0, y: 2.2, w: 4.0 },
      { type: 'bridge', x: 134.0, y: 2.2, w: 26.0, sag: 2.4 },
      { type: 'flat', x: 160.0, y: 2.2, w: 4.0 },
      { type: 'ramp', x: 164.0, y: 2.2, w: 7.5, rise: 4.8 },
      { type: 'flat', x: 171.5, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 175.0, y: 7.0, w: 8.0, rise: -4.8 },
      { type: 'flat', x: 183.0, y: 2.2, w: 22.0 },

      // Sector 3: Chamber of Blades Quad High-Speed Spinners (x: 205 - 295)
      { type: 'bump', x: 205.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 208.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 211.5, y: 2.2, w: 18.0 },
      { type: 'bump', x: 229.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 233.0, y: 2.2, w: 3.0 },
      { type: 'flat', x: 236.0, y: 2.2, w: 18.0 },
      { type: 'bump', x: 254.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 257.5, y: 2.2, w: 3.0 },
      { type: 'flat', x: 260.5, y: 2.2, w: 18.0 },
      { type: 'ramp', x: 278.5, y: 2.2, w: 7.0, rise: 4.2 },
      { type: 'flat', x: 285.5, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 289.0, y: 6.4, w: 7.0, rise: -4.2 },
      { type: 'flat', x: 296.0, y: 2.2, w: 9.0 },

      // Sector 4: Hydraulic Sky-Canopy Elevator & Triple High-Wire See-Saws (x: 305 - 405)
      { type: 'gap', x: 305.0, w: 13.0 },
      { type: 'moving', x: 305.8, y: 4.85, w: 11.5, range: 0, rangeY: 2.65, speed: 1.25, phase: -1.57 },
      { type: 'flat', x: 318.0, y: 7.5, w: 6.0 },
      { type: 'bridge', x: 324.0, y: 7.5, w: 24.0, sag: 2.3 },
      { type: 'flat', x: 348.0, y: 7.5, w: 4.0 },
      { type: 'ramp', x: 352.0, y: 7.5, w: 9.0, rise: -5.3 },
      { type: 'flat', x: 361.0, y: 2.2, w: 4.0 },
      { type: 'gap', x: 365.0, w: 0.8 },
      { type: 'see-saw', x: 365.8, y: 2.2, w: 10.0 },
      { type: 'gap', x: 375.8, w: 0.8 },
      { type: 'flat', x: 376.6, y: 2.2, w: 3.5 },
      { type: 'gap', x: 380.1, w: 0.8 },
      { type: 'see-saw', x: 380.9, y: 2.2, w: 10.0 },
      { type: 'gap', x: 390.9, w: 0.8 },
      { type: 'flat', x: 391.7, y: 2.2, w: 13.3 },

      // Sector 5: Twin Skyway Ferries Crossing the Abyss (x: 405 - 495)
      { type: 'gap', x: 405.0, w: 15.0 },
      { type: 'moving', x: 407.2, y: 2.2, w: 8.5, range: 2.6, speed: 1.5, phase: 0 },
      { type: 'flat', x: 420.0, y: 2.2, w: 6.0 },
      { type: 'bump', x: 426.0, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 429.5, y: 2.2, w: 4.0 },
      { type: 'gap', x: 433.5, w: 15.0 },
      { type: 'moving', x: 435.7, y: 2.2, w: 8.5, range: 2.6, speed: 1.6, phase: 3.14 },
      { type: 'flat', x: 448.5, y: 2.2, w: 6.0 },
      { type: 'bridge', x: 454.5, y: 2.2, w: 20.0, sag: 1.6 },
      { type: 'flat', x: 474.5, y: 2.2, w: 20.5 },

      // Sector 6: Precision Nitro Leap & Bounce Spring onto Alpine Perch (x: 495 - 580)
      { type: 'boost', x: 495.0, y: 2.2, w: 6.0, rise: 2.0, power: 34 },
      { type: 'gap', x: 501.0, w: 5.0 },
      { type: 'ramp', x: 506.0, y: 4.2, w: 6.5, rise: -1.0 },
      { type: 'flat', x: 512.5, y: 3.2, w: 6.0 },
      { type: 'bump', x: 518.5, y: 3.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 522.0, y: 3.2, w: 3.0 },
      { type: 'bounce', x: 525.0, y: 3.2, w: 3.0, power: 15.5 },
      { type: 'gap', x: 528.0, w: 1.2 },
      { type: 'flat', x: 529.2, y: 4.8, w: 10.0 },
      { type: 'ramp', x: 539.2, y: 4.8, w: 7.3, rise: -2.6 },
      { type: 'flat', x: 546.5, y: 2.2, w: 6.0 },
      { type: 'bridge', x: 552.5, y: 2.2, w: 18.0, sag: 1.5 },
      { type: 'flat', x: 570.5, y: 2.2, w: 9.5 },

      // Sector 7: The Titan's Spine — Extreme Parabolic Peak (x: 580 - 640)
      { type: 'ramp', x: 580.0, y: 2.2, w: 7.5, rise: 5.5 },
      { type: 'flat', x: 587.5, y: 7.7, w: 3.5 },
      { type: 'ramp', x: 591.0, y: 7.7, w: 7.5, rise: -5.5 },
      { type: 'flat', x: 598.5, y: 2.2, w: 4.0 },
      { type: 'bump', x: 602.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 606.0, y: 2.2, w: 3.0 },
      { type: 'ramp', x: 609.0, y: 2.2, w: 6.5, rise: 4.2 },
      { type: 'flat', x: 615.5, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 619.0, y: 6.4, w: 6.5, rise: -4.2 },
      { type: 'flat', x: 625.5, y: 2.2, w: 14.5 },

      // Sector 8: Grand Roller-Coaster Switchbacks & Hypersonic Finale (x: 640 - 740)
      { type: 'ramp', x: 640.0, y: 2.2, w: 6.5, rise: 5.2 },
      { type: 'flat', x: 646.5, y: 7.4, w: 3.5 },
      { type: 'ramp', x: 650.0, y: 7.4, w: 6.5, rise: -5.2 },
      { type: 'ramp', x: 656.5, y: 2.2, w: 6.5, rise: 4.6 },
      { type: 'flat', x: 663.0, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 666.5, y: 6.8, w: 6.5, rise: -4.6 },
      { type: 'ramp', x: 673.0, y: 2.2, w: 6.0, rise: 4.0 },
      { type: 'flat', x: 679.0, y: 6.2, w: 3.5 },
      { type: 'ramp', x: 682.5, y: 6.2, w: 6.0, rise: -4.0 },
      { type: 'flat', x: 688.5, y: 2.2, w: 4.0 },
      { type: 'boost', x: 692.5, y: 2.2, w: 8.0, rise: 0, power: 36 },
      { type: 'flat', x: 700.5, y: 2.2, w: 40.0 },
    ],
    obstacles: [
      { type: 'spinner', x: 220.0, y: 6.1, r: 1.5, speed: 2.4 },
      { type: 'spinner', x: 245.0, y: 6.1, r: 1.5, speed: -2.6 },
      { type: 'spinner', x: 270.0, y: 6.1, r: 1.5, speed: 2.8 },
      { type: 'spinner', x: 464.5, y: 5.8, r: 1.3, speed: -2.4 },
      { type: 'spinner', x: 561.5, y: 5.7, r: 1.3, speed: 2.6 },
      { type: 'spinner', x: 602.5, y: 6.1, r: 1.5, speed: -2.5 },
    ]
  },
