...
const LEVELS = [
  ...
  // 25: Sawmill Colossus (Quad Spinners, Extreme Switchbacks, Ferry & Spring Leap)
  {
    ...
    segments: [
      ...
      { type: 'bounce', x: 442.99, y: 2.2, w: 3.0, power: 15 },
      { type: 'gap', x: 446.2, w: 1.2 },
  ...
  // 26: Emerald Ridgeline Colossus — Bridge-First opener, dual boost runs, triple see-saw, spinner corridor
  {
    name: 'Level 26: Emerald Ridgeline Colossus', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 600,
    segments: [
      // Sector 1: Bridge opener & rolling hills (x: 0 - 90)
      { type: 'flat', x: 0, y: 2, w: 8 },
      { type: 'bridge', x: 8, y: 2, w: 20, sag: 1.4 },
      { type: 'flat', x: 28, y: 2, w: 5 },
      { type: 'bump', x: 33, y: 2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 36.5, y: 2, w: 3 },
      { type: 'ramp', x: 39.5, y: 2, w: 6, rise: 3.0 },
      { type: 'flat', x: 45.5, y: 5.0, w: 4 },
      { type: 'ramp', x: 49.5, y: 5.0, w: 6, rise: -3.0 },
      { type: 'flat', x: 55.5, y: 2, w: 4 },
      { type: 'bump', x: 59.5, y: 2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 63, y: 2, w: 3 },
      { type: 'ramp', x: 66, y: 2, w: 6.5, rise: 3.5 },
      { type: 'flat', x: 72.5, y: 5.5, w: 4 },
      { type: 'ramp', x: 76.5, y: 5.5, w: 6.5, rise: -3.5 },
      { type: 'flat', x: 83, y: 2.2, w: 17 },

      // Sector 2: Nitro boost run & camelback sequence (x: 100 - 180)
      { type: 'boost', x: 100, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 107, y: 2.2, w: 5 },
      { type: 'bump', x: 112, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 115.5, y: 2.2, w: 4 },
      { type: 'bump', x: 119.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 123, y: 2.2, w: 4 },
      { type: 'ramp', x: 127, y: 2.2, w: 7, rise: 4.0 },
      { type: 'flat', x: 134, y: 6.2, w: 4 },
      { type: 'ramp', x: 138, y: 6.2, w: 7, rise: -4.0 },
      { type: 'flat', x: 145, y: 2.2, w: 5 },
      { type: 'boost', x: 150, y: 2.2, w: 7, rise: 0, power: 30 },
      { type: 'flat', x: 157, y: 2.2, w: 23 },

      // Sector 3: Spinner corridor — 4 blades with bumps between (x: 180 - 280)
      { type: 'bump', x: 180, y: 2.2, w: 3.5, h: 0.58 },
      { type: 'flat', x: 183.5, y: 2.2, w: 18 },
      { type: 'bump', x: 201.5, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 205, y: 2.2, w: 18 },
      { type: 'bump', x: 223, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 226.5, y: 2.2, w: 18 },
      { type: 'bump', x: 244.5, y: 2.2, w: 3.5, h: 0.64 },
      { type: 'flat', x: 248, y: 2.2, w: 8 },
      { type: 'ramp', x: 256, y: 2.2, w: 7, rise: 3.8 },
      { type: 'flat', x: 263, y: 6.0, w: 4 },
      { type: 'ramp', x: 267, y: 6.0, w: 7, rise: -3.8 },
      { type: 'flat', x: 274, y: 2.2, w: 16 },

      // Sector 4: Canopy elevator → high bridge → triple see-saw (x: 290 - 400)
      { type: 'gap', x: 290, w: 13 },
      { type: 'moving', x: 290.8, y: 4.75, w: 11.5, range: 0, rangeY: 2.55, speed: 1.15, phase: -1.57 },
      { type: 'flat', x: 303, y: 7.3, w: 6 },
      { type: 'bridge', x: 309, y: 7.3, w: 22, sag: 2.1 },
      { type: 'flat', x: 331, y: 7.3, w: 4 },
      { type: 'ramp', x: 335, y: 7.3, w: 8.5, rise: -5.1 },
      { type: 'flat', x: 343.5, y: 2.2, w: 4 },
      { type: 'gap', x: 347.5, w: 0.8 },
      { type: 'see-saw', x: 348.3, y: 2.2, w: 10 },
      { type: 'gap', x: 358.3, w: 0.8 },
      { type: 'flat', x: 359.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 362.6, w: 0.8 },
      { type: 'see-saw', x: 363.4, y: 2.2, w: 10 },
      { type: 'gap', x: 373.4, w: 0.8 },
      { type: 'flat', x: 374.2, y: 2.2, w: 3.5 },
      { type: 'gap', x: 377.7, w: 0.8 },
      { type: 'see-saw', x: 378.5, y: 2.2, w: 10 },
      { type: 'gap', x: 388.5, w: 0.8 },
      { type: 'flat', x: 389.3, y: 2.2, w: 10.7 },

      // Sector 5: Skyway ferry + spring bounce (x: 400 - 475)
      { type: 'gap', x: 400, w: 14 },
      { type: 'moving', x: 402, y: 2.2, w: 8.5, range: 2.8, speed: 1.5, phase: 0 },
      { type: 'flat', x: 414, y: 2.2, w: 6 },
      { type: 'bump', x: 420, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 423.5, y: 2.2, w: 4 },
      { type: 'bounce', x: 427.5, y: 2.2, w: 3, power: 15 },
      { type: 'gap', x: 430.5, w: 1.2 },
      { type: 'flat', x: 431.7, y: 3.8, w: 10 },
      { type: 'ramp', x: 441.7, y: 3.8, w: 7, rise: -1.6 },
      { type: 'flat', x: 448.7, y: 2.2, w: 6 },
      { type: 'bridge', x: 454.7, y: 2.2, w: 16, sag: 1.4 },
      { type: 'flat', x: 470.7, y: 2.2, w: 9.3 },

      // Sector 6: Steep ridge climb + boost sprint + roller finale (x: 480 - 625)
      { type: 'ramp', x: 480, y: 2.2, w: 7, rise: 4.6 },
      { type: 'flat', x: 487, y: 6.8, w: 4 },
      { type: 'ramp', x: 491, y: 6.8, w: 7, rise: -4.6 },
      { type: 'flat', x: 498, y: 2.2, w: 5 },
      { type: 'boost', x: 503, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 510, y: 2.2, w: 5 },
      { type: 'ramp', x: 515, y: 2.2, w: 6.5, rise: 4.2 },
      { type: 'flat', x: 521.5, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 525, y: 6.4, w: 6.5, rise: -4.2 },
      { type: 'ramp', x: 531.5, y: 2.2, w: 6, rise: 3.6 },
      { type: 'flat', x: 537.5, y: 5.8, w: 3.5 },
      { type: 'ramp', x: 541, y: 5.8, w: 6, rise: -3.6 },
      { type: 'ramp', x: 547, y: 2.2, w: 5.5, rise: 3.0 },
      { type: 'flat', x: 552.5, y: 5.2, w: 3.5 },
      { type: 'ramp', x: 556, y: 5.2, w: 5.5, rise: -3.0 },
      { type: 'flat', x: 561.5, y: 2.2, w: 4 },
      { type: 'boost', x: 565.5, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 572.5, y: 2.2, w: 52.5 },
    ],
    obstacles: [
      { type: 'spinner', x: 190, y: 6.1, r: 1.5, speed: 2.3 },
      { type: 'spinner', x: 214, y: 6.1, r: 1.5, speed: -2.3 },
      { type: 'spinner', x: 238, y: 6.1, r: 1.5, speed: 2.5 },
      { type: 'spinner', x: 262, y: 11.1, r: 1.5, speed: -2.5 },
    ]
  },

  // 27: Timberline Ravine Fury — Deep V-plunges, dual ferry crossing, see-saw ridge, boost finale
  {
    name: 'Level 27: Timberline Ravine Fury', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 620,
    segments: [
      // Sector 1: Immediate steep ridge + camelback (x: 0 - 90)
      { type: 'flat', x: 0, y: 2, w: 7 },
      { type: 'ramp', x: 7, y: 2, w: 7, rise: 4.0 },
      { type: 'flat', x: 14, y: 6.0, w: 4 },
      { type: 'ramp', x: 18, y: 6.0, w: 7, rise: -4.0 },
      { type: 'flat', x: 25, y: 2.2, w: 4 },
      { type: 'bump', x: 29, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 32.5, y: 2.2, w: 3 },
      { type: 'bump', x: 35.5, y: 2.2, w: 3.5, h: 0.68 },
      { type: 'flat', x: 39, y: 2.2, w: 4 },
      { type: 'ramp', x: 43, y: 2.2, w: 7, rise: 4.4 },
      { type: 'flat', x: 50, y: 6.6, w: 4 },
      { type: 'ramp', x: 54, y: 6.6, w: 7.5, rise: -4.4 },
      { type: 'flat', x: 61.5, y: 2.2, w: 28.5 },

      // Sector 2: Spinner corridor (4 blades, wide flat runs) (x: 90 - 185)
      { type: 'flat', x: 90, y: 2.2, w: 6 },
      { type: 'bump', x: 96, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 99.5, y: 2.2, w: 20 },
      { type: 'bump', x: 119.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 123, y: 2.2, w: 20 },
      { type: 'bump', x: 143, y: 2.2, w: 3.5, h: 0.64 },
      { type: 'flat', x: 146.5, y: 2.2, w: 20 },
      { type: 'bump', x: 166.5, y: 2.2, w: 3.5, h: 0.66 },
      { type: 'flat', x: 170, y: 2.2, w: 15 },

      // Sector 3: Deep ravine plunge + suspension bridge + ascent (x: 185 - 280)
      { type: 'ramp', x: 185, y: 2.2, w: 8, rise: 4.8 },
      { type: 'flat', x: 193, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 196.5, y: 7.0, w: 8.5, rise: -4.8 },
      { type: 'flat', x: 205, y: 2.2, w: 4 },
      { type: 'bridge', x: 209, y: 2.2, w: 24, sag: 2.2 },
      { type: 'flat', x: 233, y: 2.2, w: 4 },
      { type: 'ramp', x: 237, y: 2.2, w: 7, rise: 4.5 },
      { type: 'flat', x: 244, y: 6.7, w: 3.5 },
      { type: 'ramp', x: 247.5, y: 6.7, w: 7.5, rise: -4.5 },
      { type: 'flat', x: 255, y: 2.2, w: 25 },

      // Sector 4: Boost run + canopy elevator + tandem see-saws (x: 280 - 380)
      { type: 'boost', x: 280, y: 2.2, w: 7, rise: 0, power: 32 },
      { type: 'flat', x: 287, y: 2.2, w: 5 },
      { type: 'gap', x: 292, w: 13 },
      { type: 'moving', x: 292.8, y: 4.8, w: 11.5, range: 0, rangeY: 2.6, speed: 1.2, phase: -1.57 },
      { type: 'flat', x: 305, y: 7.4, w: 5 },
      { type: 'ramp', x: 310, y: 7.4, w: 8.5, rise: -5.2 },
      { type: 'flat', x: 318.5, y: 2.2, w: 4 },
      { type: 'gap', x: 322.5, w: 0.8 },
      { type: 'see-saw', x: 323.3, y: 2.2, w: 10 },
      { type: 'gap', x: 333.3, w: 0.8 },
      { type: 'flat', x: 334.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 337.6, w: 0.8 },
      { type: 'see-saw', x: 338.4, y: 2.2, w: 10 },
      { type: 'gap', x: 348.4, w: 0.8 },
      { type: 'flat', x: 349.2, y: 2.2, w: 30.8 },

      // Sector 5: Steep apex + roller waves (x: 380 - 460)
      { type: 'ramp', x: 380, y: 2.2, w: 7, rise: 4.8 },
      { type: 'flat', x: 387, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 390.5, y: 7.0, w: 7, rise: -4.8 },
      { type: 'ramp', x: 397.5, y: 2.2, w: 6.5, rise: 4.0 },
      { type: 'flat', x: 404, y: 6.2, w: 3.5 },
      { type: 'ramp', x: 407.5, y: 6.2, w: 6.5, rise: -4.0 },
      { type: 'ramp', x: 414, y: 2.2, w: 6, rise: 3.4 },
      { type: 'flat', x: 420, y: 5.6, w: 3.5 },
      { type: 'ramp', x: 423.5, y: 5.6, w: 6, rise: -3.4 },
      { type: 'flat', x: 429.5, y: 2.2, w: 30.5 },

      // Sector 6: Dual skyway ferries + bounce (x: 460 - 545)
      { type: 'gap', x: 460, w: 14 },
      { type: 'moving', x: 462, y: 2.2, w: 8.5, range: 2.6, speed: 1.5, phase: 0 },
      { type: 'flat', x: 474, y: 2.2, w: 5 },
      { type: 'bump', x: 479, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 482.5, y: 2.2, w: 4 },
      { type: 'gap', x: 486.5, w: 14 },
      { type: 'moving', x: 488.5, y: 2.2, w: 8.5, range: 2.6, speed: 1.6, phase: 3.14 },
      { type: 'flat', x: 500.5, y: 2.2, w: 6 },
      { type: 'bridge', x: 506.5, y: 2.2, w: 18, sag: 1.4 },
      { type: 'flat', x: 524.5, y: 2.2, w: 20.5 },

      // Sector 7: Boost blast + quad switchbacks + finish (x: 545 - 645)
      { type: 'boost', x: 545, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 552, y: 2.2, w: 4 },
      { type: 'ramp', x: 556, y: 2.2, w: 6.5, rise: 4.8 },
      { type: 'flat', x: 562.5, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 566, y: 7.0, w: 6.5, rise: -4.8 },
      { type: 'ramp', x: 572.5, y: 2.2, w: 6.5, rise: 4.4 },
      { type: 'flat', x: 579, y: 6.6, w: 3.5 },
      { type: 'ramp', x: 582.5, y: 6.6, w: 6.5, rise: -4.4 },
      { type: 'ramp', x: 589, y: 2.2, w: 6, rise: 3.8 },
      { type: 'flat', x: 595, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 598.5, y: 6.0, w: 6, rise: -3.8 },
      { type: 'flat', x: 604.5, y: 2.2, w: 4 },
      { type: 'boost', x: 608.5, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 615.5, y: 2.2, w: 49.5 },
    ],
    obstacles: [
      { type: 'spinner', x: 104, y: 6.1, r: 1.5, speed: 2.3 },
      { type: 'spinner', x: 128, y: 6.1, r: 1.5, speed: -2.5 },
      { type: 'spinner', x: 152, y: 6.1, r: 1.5, speed: 2.7 },
      { type: 'spinner', x: 176, y: 6.1, r: 1.5, speed: -2.3 },
      { type: 'spinner', x: 315, y: 11.7, r: 1.3, speed: 2.4 },
    ]
  },

  // 28: Alpine Apex Gauntlet — 5-tier staircase, triple ferry, monster see-saw chain, quad spinners
  {
    name: 'Level 28: Alpine Apex Gauntlet', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 640,
    segments: [
      // Sector 1: Monster washboard + 5-tier alpine staircase (x: 0 - 90)
      { type: 'flat', x: 0, y: 2, w: 7 },
      { type: 'bump', x: 7, y: 2, w: 3.5, h: 0.68 },
      { type: 'flat', x: 10.5, y: 2, w: 2.5 },
      { type: 'bump', x: 13, y: 2, w: 3.5, h: 0.74 },
      { type: 'flat', x: 16.5, y: 2, w: 3 },
      { type: 'ramp', x: 19.5, y: 2.0, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 22, y: 3.2, w: 3.5 },
      { type: 'ramp', x: 25.5, y: 3.2, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 28, y: 4.4, w: 3.5 },
      { type: 'ramp', x: 31.5, y: 4.4, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 34, y: 5.6, w: 3.5 },
      { type: 'ramp', x: 37.5, y: 5.6, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 40, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 43.5, y: 6.8, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 46, y: 8.0, w: 4.5 },
      { type: 'ramp', x: 50.5, y: 8.0, w: 9.5, rise: -5.8 },
      { type: 'flat', x: 60, y: 2.2, w: 4 },
      { type: 'bump', x: 64, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 67.5, y: 2.2, w: 3 },
      { type: 'ramp', x: 70.5, y: 2.2, w: 6.5, rise: 3.5 },
      { type: 'flat', x: 77, y: 5.7, w: 3.5 },
      { type: 'ramp', x: 80.5, y: 5.7, w: 6.5, rise: -3.5 },
      { type: 'flat', x: 87, y: 2.2, w: 23 },

      // Sector 2: Double-boost corridor into quad spinner chamber (x: 110 - 205)
      { type: 'boost', x: 110, y: 2.2, w: 7, rise: 0, power: 30 },
      { type: 'flat', x: 117, y: 2.2, w: 5 },
      { type: 'bump', x: 122, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 125.5, y: 2.2, w: 20 },
      { type: 'bump', x: 145.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 149, y: 2.2, w: 20 },
      { type: 'boost', x: 169, y: 2.2, w: 7, rise: 0, power: 30 },
      { type: 'flat', x: 176, y: 2.2, w: 29 },

      // Sector 3: Deep canyon plunge + canopy lift + high wire bridge (x: 205 - 305)
      { type: 'ramp', x: 205, y: 2.2, w: 8, rise: 5.0 },
      { type: 'flat', x: 213, y: 7.2, w: 3.5 },
      { type: 'ramp', x: 216.5, y: 7.2, w: 8.5, rise: -5.0 },
      { type: 'flat', x: 225, y: 2.2, w: 5 },
      { type: 'gap', x: 230, w: 13 },
      { type: 'moving', x: 230.8, y: 4.85, w: 11.5, range: 0, rangeY: 2.65, speed: 1.2, phase: -1.57 },
      { type: 'flat', x: 243, y: 7.5, w: 6 },
      { type: 'bridge', x: 249, y: 7.5, w: 24, sag: 2.3 },
      { type: 'flat', x: 273, y: 7.5, w: 4 },
      { type: 'ramp', x: 277, y: 7.5, w: 9, rise: -5.3 },
      { type: 'flat', x: 286, y: 2.2, w: 19 },

      // Sector 4: Triple see-saw + steep ridge (x: 305 - 405)
      { type: 'ramp', x: 305, y: 2.2, w: 7, rise: 5.0 },
      { type: 'flat', x: 312, y: 7.2, w: 3.5 },
      { type: 'ramp', x: 315.5, y: 7.2, w: 7, rise: -5.0 },
      { type: 'flat', x: 322.5, y: 2.2, w: 4 },
      { type: 'gap', x: 326.5, w: 0.8 },
      { type: 'see-saw', x: 327.3, y: 2.2, w: 10 },
      { type: 'gap', x: 337.3, w: 0.8 },
      { type: 'flat', x: 338.1, y: 2.2, w: 3.5 },
      { type: 'gap', x: 341.6, w: 0.8 },
      { type: 'see-saw', x: 342.4, y: 2.2, w: 10 },
      { type: 'gap', x: 352.4, w: 0.8 },
      { type: 'flat', x: 353.2, y: 2.2, w: 3.5 },
      { type: 'gap', x: 356.7, w: 0.8 },
      { type: 'see-saw', x: 357.5, y: 2.2, w: 10 },
      { type: 'gap', x: 367.5, w: 0.8 },
      { type: 'flat', x: 368.3, y: 2.2, w: 4 },
      { type: 'ramp', x: 372.3, y: 2.2, w: 6.5, rise: 3.8 },
      { type: 'flat', x: 378.8, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 382.3, y: 6.0, w: 7, rise: -3.8 },
      { type: 'flat', x: 389.3, y: 2.2, w: 15.7 },

      // Sector 5: Skyway ferry + bounce + suspended bridge (x: 405 - 495)
      { type: 'gap', x: 405, w: 14.5 },
      { type: 'moving', x: 407, y: 2.2, w: 8.5, range: 2.6, speed: 1.55, phase: 0 },
      { type: 'flat', x: 419.5, y: 2.2, w: 6 },
      { type: 'bump', x: 425.5, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 429, y: 2.2, w: 3 },
      { type: 'bounce', x: 432, y: 2.2, w: 3, power: 15.5 },
      { type: 'gap', x: 435, w: 1.2 },
      { type: 'flat', x: 436.2, y: 3.8, w: 10 },
      { type: 'ramp', x: 446.2, y: 3.8, w: 7.3, rise: -1.6 },
      { type: 'flat', x: 453.5, y: 2.2, w: 6 },
      { type: 'bridge', x: 459.5, y: 2.2, w: 18, sag: 1.5 },
      { type: 'flat', x: 477.5, y: 2.2, w: 17.5 },

      // Sector 6: Boost sprint + quad roller switchbacks + nitro finish (x: 495 - 665)
      { type: 'boost', x: 495, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 502, y: 2.2, w: 5 },
      { type: 'ramp', x: 507, y: 2.2, w: 6.5, rise: 5.0 },
      { type: 'flat', x: 513.5, y: 7.2, w: 3.5 },
      { type: 'ramp', x: 517, y: 7.2, w: 6.5, rise: -5.0 },
      { type: 'ramp', x: 523.5, y: 2.2, w: 6.5, rise: 4.6 },
      { type: 'flat', x: 530, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 533.5, y: 6.8, w: 6.5, rise: -4.6 },
      { type: 'ramp', x: 540, y: 2.2, w: 6, rise: 4.0 },
      { type: 'flat', x: 546, y: 6.2, w: 3.5 },
      { type: 'ramp', x: 549.5, y: 6.2, w: 6, rise: -4.0 },
      { type: 'ramp', x: 555.5, y: 2.2, w: 5.5, rise: 3.2 },
      { type: 'flat', x: 561, y: 5.4, w: 3.5 },
      { type: 'ramp', x: 564.5, y: 5.4, w: 5.5, rise: -3.2 },
      { type: 'flat', x: 570, y: 2.2, w: 4 },
      { type: 'boost', x: 574, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 581, y: 2.2, w: 64 },
    ],
    obstacles: [
      { type: 'spinner', x: 131, y: 6.1, r: 1.5, speed: 2.5 },
      { type: 'spinner', x: 155, y: 6.1, r: 1.5, speed: -2.5 },
      { type: 'spinner', x: 315, y: 5.7, r: 1.3, speed: 2.4 },
      { type: 'spinner', x: 463, y: 5.7, r: 1.3, speed: -2.6 },
      { type: 'spinner', x: 486, y: 5.7, r: 1.3, speed: 2.4 },
    ]
  },

  // 29: Overdrive Gorge — immediate skyway, matrix spinners, 6-tier escalator, see-saw chain, boss finale
  {
    name: 'Level 29: Overdrive Gorge', theme: 'forest', spawnX: 1.5, spawnY: 3, finishX: 660,
    segments: [
      // Sector 1: Immediate gap/ferry + rolling moguls (x: 0 - 100)
      { type: 'flat', x: 0, y: 2, w: 8 },
      { type: 'gap', x: 8, w: 14 },
      { type: 'moving', x: 9, y: 2.2, w: 8.5, range: 2.8, speed: 1.4, phase: 0 },
      { type: 'flat', x: 22, y: 2.2, w: 5 },
      { type: 'bump', x: 27, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 30.5, y: 2.2, w: 3 },
      { type: 'bump', x: 33.5, y: 2.2, w: 3.5, h: 0.70 },
      { type: 'flat', x: 37, y: 2.2, w: 4 },
      { type: 'ramp', x: 41, y: 2.2, w: 6.5, rise: 3.8 },
      { type: 'flat', x: 47.5, y: 6.0, w: 3.5 },
      { type: 'ramp', x: 51, y: 6.0, w: 6.5, rise: -3.8 },
      { type: 'flat', x: 57.5, y: 2.2, w: 4 },
      { type: 'bump', x: 61.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 65, y: 2.2, w: 3 },
      { type: 'ramp', x: 68, y: 2.2, w: 7, rise: 4.2 },
      { type: 'flat', x: 75, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 78.5, y: 6.4, w: 7, rise: -4.2 },
      { type: 'flat', x: 85.5, y: 2.2, w: 14.5 },

      // Sector 2: Matrix spinner gauntlet (4 blades, with bumps) (x: 100 - 200)
      { type: 'boost', x: 100, y: 2.2, w: 7, rise: 0, power: 30 },
      { type: 'flat', x: 107, y: 2.2, w: 4 },
      { type: 'bump', x: 111, y: 2.2, w: 3.5, h: 0.62 },
      { type: 'flat', x: 114.5, y: 2.2, w: 22 },
      { type: 'bump', x: 136.5, y: 2.2, w: 3.5, h: 0.64 },
      { type: 'flat', x: 140, y: 2.2, w: 22 },
      { type: 'bump', x: 162, y: 2.2, w: 3.5, h: 0.66 },
      { type: 'flat', x: 165.5, y: 2.2, w: 22 },
      { type: 'bump', x: 187.5, y: 2.2, w: 3.5, h: 0.68 },
      { type: 'flat', x: 191, y: 2.2, w: 9 },

      // Sector 3: 6-tier stepped escalator → big plunge (x: 200 - 290)
      { type: 'ramp', x: 200, y: 2.2, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 202.5, y: 3.4, w: 3 },
      { type: 'ramp', x: 205.5, y: 3.4, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 208, y: 4.6, w: 3 },
      { type: 'ramp', x: 211, y: 4.6, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 213.5, y: 5.8, w: 3 },
      { type: 'ramp', x: 216.5, y: 5.8, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 219, y: 7.0, w: 3 },
      { type: 'ramp', x: 222, y: 7.0, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 224.5, y: 8.2, w: 3 },
      { type: 'ramp', x: 227.5, y: 8.2, w: 2.5, rise: 1.0 },
      { type: 'flat', x: 230, y: 9.2, w: 4.5 },
      { type: 'ramp', x: 234.5, y: 9.2, w: 11, rise: -7.0 },
      { type: 'flat', x: 245.5, y: 2.2, w: 5 },
      { type: 'bump', x: 250.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 254, y: 2.2, w: 36 },

      // Sector 4: Hydraulic canopy lift + triple high-wire see-saws (x: 290 - 400)
      { type: 'gap', x: 290, w: 13 },
      { type: 'moving', x: 290.8, y: 4.85, w: 11.5, range: 0, rangeY: 2.65, speed: 1.25, phase: -1.57 },
      { type: 'flat', x: 303, y: 7.5, w: 6 },
      { type: 'bridge', x: 309, y: 7.5, w: 24, sag: 2.3 },
      { type: 'flat', x: 333, y: 7.5, w: 4 },
      { type: 'ramp', x: 337, y: 7.5, w: 9, rise: -5.3 },
      { type: 'flat', x: 346, y: 2.2, w: 4 },
      { type: 'gap', x: 350, w: 0.8 },
      { type: 'see-saw', x: 350.8, y: 2.2, w: 10 },
      { type: 'gap', x: 360.8, w: 0.8 },
      { type: 'flat', x: 361.6, y: 2.2, w: 3.5 },
      { type: 'gap', x: 365.1, w: 0.8 },
      { type: 'see-saw', x: 365.9, y: 2.2, w: 10 },
      { type: 'gap', x: 375.9, w: 0.8 },
      { type: 'flat', x: 376.7, y: 2.2, w: 3.5 },
      { type: 'gap', x: 380.2, w: 0.8 },
      { type: 'see-saw', x: 381, y: 2.2, w: 10 },
      { type: 'gap', x: 391, w: 0.8 },
      { type: 'flat', x: 391.8, y: 2.2, w: 8.2 },

      // Sector 5: Boost run + roller peaks (x: 400 - 490)
      { type: 'boost', x: 400, y: 2.2, w: 7, rise: 0, power: 32 },
      { type: 'flat', x: 407, y: 2.2, w: 5 },
      { type: 'ramp', x: 412, y: 2.2, w: 6.5, rise: 4.6 },
      { type: 'flat', x: 418.5, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 422, y: 6.8, w: 6.5, rise: -4.6 },
      { type: 'ramp', x: 428.5, y: 2.2, w: 6.5, rise: 4.0 },
      { type: 'flat', x: 435, y: 6.2, w: 3.5 },
      { type: 'ramp', x: 438.5, y: 6.2, w: 6.5, rise: -4.0 },
      { type: 'ramp', x: 445, y: 2.2, w: 6, rise: 3.4 },
      { type: 'flat', x: 451, y: 5.6, w: 3.5 },
      ...
      { type: 'flat', x: 504, y: 2.2, w: 5 },
      { type: 'bump', x: 509, y: 2.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 512.5, y: 2.2, w: 3 },
      { type: 'bounce', x: 515.5, y: 2.2, w: 3, power: 15.5 },
      { type: 'gap', x: 518.5, w: 1.2 },
      { type: 'flat', x: 519.7, y: 3.8, w: 10 },
      { type: 'ramp', x: 529.7, y: 3.8, w: 7.3, rise: -1.6 },
      { type: 'flat', x: 537, y: 2.2, w: 6 },
      { type: 'bridge', x: 543, y: 2.2, w: 18, sag: 1.5 },
      { type: 'flat', x: 561, y: 2.2, w: 19 },

      // Sector 7: Nitro boost + quintuple switchbacks + finish (x: 580 - 685)
      { type: 'boost', x: 580, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 587, y: 2.2, w: 3 },
      { type: 'ramp', x: 590, y: 2.2, w: 6.5, rise: 5.2 },
      { type: 'flat', x: 596.5, y: 7.4, w: 3.5 },
      { type: 'ramp', x: 600, y: 7.4, w: 6.5, rise: -5.2 },
      { type: 'ramp', x: 606.5, y: 2.2, w: 6.5, rise: 4.8 },
      { type: 'flat', x: 613, y: 7.0, w: 3.5 },
      { type: 'ramp', x: 616.5, y: 7.0, w: 6.5, rise: -4.8 },
      { type: 'ramp', x: 623, y: 2.2, w: 6, rise: 4.2 },
      { type: 'flat', x: 629, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 632.5, y: 6.4, w: 6, rise: -4.2 },
      { type: 'ramp', x: 638.5, y: 2.2, w: 5.5, rise: 3.6 },
      { type: 'flat', x: 644, y: 5.8, w: 3.5 },
      { type: 'ramp', x: 647.5, y: 5.8, w: 5.5, rise: -3.6 },
    ...
    obstacles: [
      ...
      { type: 'spinner', x: 143, y: 6.1, r: 1.5, speed: -2.7 },
      { type: 'spinner', x: 168, y: 6.1, r: 1.5, speed: 2.9 },
      { type: 'spinner', x: 193, y: 6.1, r: 1.5, speed: -2.5 },
      { type: 'spinner', x: 337, y: 5.7, r: 1.3, speed: 2.5 },
      { type: 'spinner', x: 555, y: 5.7, r: 1.3, speed: -2.6 },
    ]
  },
  ...
  // 30: The Forest Titan Colossus — 8 sectors, canyon bridge opener, see-saw + ferry + escalator combos, 7 spinners
  {
    ...
    segments: [
      ...
      { type: 'flat', x: 0, y: 2, w: 8 },
      { type: 'ramp', x: 8, y: 2, w: 7.5, rise: 4.8 },
      { type: 'flat', x: 15.5, y: 6.8, w: 3.5 },
      { type: 'ramp', x: 19, y: 6.8, w: 8, rise: -4.8 },
      { type: 'flat', x: 27, y: 2.2, w: 4 },
      { type: 'bridge', x: 31, y: 2.2, w: 26, sag: 2.4 },
      { type: 'flat', x: 57, y: 2.2, w: 4 },
      { type: 'bump', x: 61, y: 2.2, w: 3.5, h: 0.70 },
      { type: 'flat', x: 64.5, y: 2.2, w: 3 },
      { type: 'bump', x: 67.5, y: 2.2, w: 3.5, h: 0.75 },
      { type: 'flat', x: 71, y: 2.2, w: 29 },

      // Sector 2: Boost launch + 6-tier escalator → plunge (x: 100 - 200)
      { type: 'boost', x: 100, y: 2.2, w: 7, rise: 0, power: 34 },
      { type: 'flat', x: 107, y: 2.2, w: 5 },
      { type: 'ramp', x: 112, y: 2.2, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 114.5, y: 3.4, w: 3 },
      { type: 'ramp', x: 117.5, y: 3.4, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 120, y: 4.6, w: 3 },
      { type: 'ramp', x: 123, y: 4.6, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 125.5, y: 5.8, w: 3 },
      { type: 'ramp', x: 128.5, y: 5.8, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 131, y: 7.0, w: 3 },
      { type: 'ramp', x: 134, y: 7.0, w: 2.5, rise: 1.2 },
      { type: 'flat', x: 136.5, y: 8.2, w: 3 },
      { type: 'ramp', x: 139.5, y: 8.2, w: 2.5, rise: 1.0 },
      { type: 'flat', x: 142, y: 9.2, w: 4.5 },
      { type: 'ramp', x: 146.5, y: 9.2, w: 10, rise: -7.0 },
      { type: 'flat', x: 156.5, y: 2.2, w: 4 },
      { type: 'bump', x: 160.5, y: 2.2, w: 3.5, h: 0.68 },
      { type: 'flat', x: 164, y: 2.2, w: 36 },

      // Sector 3: Spinner corridor — 5 blades with bumps + ridge (x: 200 - 310)
      { type: 'bump', x: 200, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 203.5, y: 2.2, w: 17 },
      { type: 'bump', x: 220.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 224, y: 2.2, w: 17 },
      { type: 'bump', x: 241, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 244.5, y: 2.2, w: 17 },
      { type: 'bump', x: 261.5, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 265, y: 2.2, w: 17 },
      { type: 'ramp', x: 282, y: 2.2, w: 7, rise: 4.2 },
      { type: 'flat', x: 289, y: 6.4, w: 3.5 },
      { type: 'ramp', x: 292.5, y: 6.4, w: 7, rise: -4.2 },
      { type: 'flat', x: 299.5, y: 2.2, w: 10.5 },

      // Sector 4: Hydraulic elevator + high bridge + tandem see-saws (x: 310 - 430)
      { type: 'gap', x: 310, w: 13 },
      { type: 'moving', x: 310.8, y: 4.85, w: 11.5, range: 0, rangeY: 2.65, speed: 1.25, phase: -1.57 },
      { type: 'flat', x: 323, y: 7.5, w: 6 },
      { type: 'bridge', x: 329, y: 7.5, w: 24, sag: 2.3 },
      { type: 'flat', x: 353, y: 7.5, w: 4 },
      { type: 'ramp', x: 357, y: 7.5, w: 9, rise: -5.3 },
      { type: 'flat', x: 366, y: 2.2, w: 4 },
      { type: 'gap', x: 370, w: 0.8 },
      { type: 'see-saw', x: 370.8, y: 2.2, w: 10 },
      { type: 'gap', x: 380.8, w: 0.8 },
      { type: 'flat', x: 381.6, y: 2.2, w: 3.5 },
      { type: 'gap', x: 385.1, w: 0.8 },
      { type: 'see-saw', x: 385.9, y: 2.2, w: 10 },
      { type: 'gap', x: 395.9, w: 0.8 },
      { type: 'flat', x: 396.7, y: 2.2, w: 3.5 },
      { type: 'gap', x: 400.2, w: 0.8 },
      { type: 'see-saw', x: 401, y: 2.2, w: 10 },
      { type: 'gap', x: 411, w: 0.8 },
      { type: 'flat', x: 411.8, y: 2.2, w: 18.2 },

      // Sector 5: Twin skyway ferries across the abyss (x: 430 - 525)
      { type: 'gap', x: 430, w: 15 },
      { type: 'moving', x: 432, y: 2.2, w: 8.5, range: 2.6, speed: 1.5, phase: 0 },
      { type: 'flat', x: 445, y: 2.2, w: 6 },
      { type: 'bump', x: 451, y: 2.2, w: 3.5, h: 0.65 },
      { type: 'flat', x: 454.5, y: 2.2, w: 4 },
      { type: 'gap', x: 458.5, w: 15 },
      { type: 'moving', x: 460.5, y: 2.2, w: 8.5, range: 2.6, speed: 1.6, phase: 3.14 },
      { type: 'flat', x: 473.5, y: 2.2, w: 6 },
      { type: 'bridge', x: 479.5, y: 2.2, w: 20, sag: 1.6 },
      { type: 'flat', x: 499.5, y: 2.2, w: 25.5 },

      // Sector 6: Nitro boost + precision leap + bounce to perch (x: 525 - 615)
      { type: 'boost', x: 525, y: 2.2, w: 7, rise: 2.0, power: 34 },
      { type: 'gap', x: 532, w: 5 },
      { type: 'ramp', x: 537, y: 4.2, w: 6.5, rise: -1.0 },
      { type: 'flat', x: 543.5, y: 3.2, w: 6 },
      { type: 'bump', x: 549.5, y: 3.2, w: 3.5, h: 0.60 },
      { type: 'flat', x: 553, y: 3.2, w: 3 },
      { type: 'bounce', x: 556, y: 3.2, w: 3, power: 15.5 },
      { type: 'gap', x: 559, w: 1.2 },
      { type: 'flat', x: 560.2, y: 4.8, w: 10 },
      { type: 'ramp', x: 570.2, y: 4.8, w: 7.3, rise: -2.6 },
      { type: 'flat', x: 577.5, y: 2.2, w: 6 },
      { type: 'bridge', x: 583.5, y: 2.2, w: 18, sag: 1.5 },
      { type: 'flat', x: 601.5, y: 2.2, w: 13.5 },

      // Sector 7: The Titan's Spine — extreme parabolic peak + see-saws (x: 615 - 680)
      { type: 'ramp', x: 615, y: 2.2, w: 7.5, rise: 5.5 },
      { type: 'flat', x: 622.5, y: 7.7, w: 3.5 },
      { type: 'ramp', x: 626, y: 7.7, w: 7.5, rise: -5.5 },
      { type: 'flat', x: 633.5, y: 2.2, w: 4 },
      { type: 'gap', x: 637.5, w: 0.8 },
      { type: 'see-saw', x: 638.3, y: 2.2, w: 10 },
